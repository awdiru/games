...
public class King extends Piece {
    public King(ChessPanel parent, Cell cell, boolean isWhite) {
        super(parent, cell, isWhite, "king.png");
    }
    ...
    public void addAllowedCells(Set<NumberCell> allowedCells) {
        ...
        for (Direction direction : Direction.values()) {
            NumberCell desired = new NumberCell(current.row() + direction.getRowOff(), current.col() + direction.getColOff());
